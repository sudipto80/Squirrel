...
public static class DataCleansersExperimental
{
		...
		public static Table AutoClean(this Table tab)
		{
			...
			//is drastically different than the rest of the values of rest of the cells 
		...
		{
			//If the values of the cells are less than 5 character long
			//then they are probably hard to pronounce and are possible acronyms.
			//For these sort of values UpperCase may be the best option. 
